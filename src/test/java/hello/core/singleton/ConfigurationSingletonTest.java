...
public class ConfigurationSingletonTest {
    ...
    @Test
    @DisplayName("스프링 @Configuration 싱글톤 테스트")
    ...
    // 내부적으로 CGLIB 기술을 사용한다
    @Test
    @DisplayName("@Configuration가 존재할 경우")
    ...
    // 싱글톤이 보장되지 않는다
    @Test
    @DisplayName("@Configuration 없이 @Bean만 존재할 경우")
    void onlyBeanExist() {
